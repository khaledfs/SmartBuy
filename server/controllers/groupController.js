...
exports.createGroup = async (req, res) => {
  ...
  try {
    const group = new Group({ name, admin: req.userId, members: [req.userId] });
    await group.save();
...
exports.addUserToGroup = async (req, res) => {
  ...
  try {
    ...
    // ✅ Emit group update
    req.app.get('io').to(group._id.toString()).emit('groupUpdate');
...
exports.deleteGroup = async (req, res) => {
  ...
  try {
    ...
    // ✅ Emit group update (last message)
    req.app.get('io').to(id).emit('groupUpdate');
